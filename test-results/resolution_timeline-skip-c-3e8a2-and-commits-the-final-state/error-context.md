...
- Name: resolution_timeline.spec.js >> skip completes playback and commits the final state
- Location: tests\resolution_timeline.spec.js:129:1
...
Locator: locator('[data-testid="resolution-complete"]')
Expected substring: "已跳过"
Received string:    "回放完成"
Timeout: 8000ms

Call log:
  - Expect "toContainText" with timeout 8000ms
  - waiting for locator('[data-testid="resolution-complete"]')
    20 × locator resolved to <div id="resolution-complete" class="resolution-complete" data-testid="resolution-complete">回放完成</div>
       - unexpected value "回放完成"
