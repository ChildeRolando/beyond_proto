...
echo Code files: engine/ server/ ui/ index.html package.json main.js styles/
...
scp -i "%USERPROFILE%\.ssh\id_ed25519" -o IdentitiesOnly=yes -r engine server ui index.html package.json main.js styles Administrator@120.77.178.15:"C:/Users/Administrator/Desktop/combat-engine/"
